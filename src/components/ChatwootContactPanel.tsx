...
import { FileText, Mail, Phone, Building, PlusCircle, Calendar, Clock, Trash2, Pencil, ImagePlus, Bot } from "lucide-react";
...
export const ChatwootContactPanel = ({ selectedConversation, messages, onNewNote, scripts, fetchCareScripts }: ChatwootContactPanelProps) => {
  ...
  return (
    <aside className="hidden lg:flex lg:w-80 border-l bg-white flex-col">
      ...
      <Tabs defaultValue="care" className="flex-1 flex flex-col">
        <TabsList className="grid w-full grid-cols-1 rounded-none h-14">
