...
interface SharePostScanDialogProps {
  isOpen: boolean;
...
export const SharePostScanDialog = ({ isOpen, onOpenChange, project, onProjectUpdate }: SharePostScanDialogProps) => {
  const [isPublic, setIsPublic] = useState(project.is_public);
  const [isLoading, setIsLoading] = useState(false);
  const publicUrl = `${window.location.origin}/public/post-scan/${project.public_id}`;
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Tạo một liên kết công khai để chia sẻ kết quả quét với người khác mà không cần họ đăng nhập.
          </DialogDescription>
        </DialogHeader>
