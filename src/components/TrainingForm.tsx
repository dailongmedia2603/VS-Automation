          ...
          <Card className="bg-white rounded-2xl shadow-sm border border-slate-200/80">
            ...
            <CardContent className="p-6 pt-0 space-y-6">
              <div className="space-y-2">
                ...
                <Input id="industry" value={config.industry} onChange={(e) => handleFieldChange('industry', e.target.value)} className="bg-slate-100/70 border-slate-200 rounded-lg h-11" />
              </div>
              <div className="space-y-2">
          ...
          <Card className="bg-white rounded-2xl shadow-sm border border-slate-200/80">
            <CardHeader className="p-6 flex flex-row items-center gap-4">
              ...
              <div>
                ...
                <CardDescription className="text-sm text-slate-500 pt-1">Định hình "tính cách" cho AI.</CardDescription>
              </div>
            </CardHeader>
            <CardContent className="p-6 pt-0 space-y-4">
              <div className="space-y-2">
                <Label htmlFor="style" className="text-sm font-medium text-slate-800">Phong cách trả lời</Label>
                <Input id="style" placeholder="VD: Thân thiện, chuyên nghiệp" value={config.style} onChange={(e) => handleFieldChange('style', e.target.value)} className="bg-slate-100/70 border-slate-200 rounded-lg h-11" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="tone" className="text-sm font-medium text-slate-800">Tông giọng trả lời</Label>
                <Input id="tone" placeholder="VD: Vui vẻ, nghiêm túc" value={config.tone} onChange={(e) => handleFieldChange('tone', e.target.value)} className="bg-slate-100/70 border-slate-200 rounded-lg h-11" />
              </div>
              <div className="space-y-2">
