...
const TrainingZaloChatbot = () => {
  ...
  return (
    <main className="flex-1 space-y-8 p-6 sm:p-8 bg-slate-50">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Training Chatbot Zalo</h1>
        <p className="text-muted-foreground mt-2 max-w-2xl">
          Dạy cho AI Zalo cách trả lời và tương tác trong các tình huống cụ thể. Cung cấp càng nhiều thông tin chi tiết, AI sẽ càng hoạt động hiệu quả và phù hợp với doanh nghiệp của bạn.
        </p>
      </div>
...
export default TrainingZaloChatbot;