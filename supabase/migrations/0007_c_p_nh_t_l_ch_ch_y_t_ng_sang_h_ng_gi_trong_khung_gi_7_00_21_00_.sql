-- Xóa lịch chạy cũ để tránh trùng lặp
SELECT cron.unschedule('care-script-scheduler-job');

-- Tạo lịch chạy mới với lịch trình tối ưu hóa
SELECT cron.schedule(
  'care-script-scheduler-job',
  '0 7-21 * * *', -- Chạy vào phút thứ 0, mỗi giờ từ 7h đến 21h hàng ngày
  $$
